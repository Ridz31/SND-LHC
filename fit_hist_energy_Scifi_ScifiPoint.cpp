/*Script to plot the TGraphs of energy v/s the no of hits for the true Scifi for each station*/
#include <fstream>
#include <cmath>
void fit_hist_energy_Scifi_ScifiPoint(){
    ...
    TFile* fin2 = new TFile("/eos/user/r/ridz01/Hist_SciFi_NC_energy_ScifiPoint_irregular_101022_200files.root","READ");
    ...
    ofstream file;
    file.open ("/eos/user/r/ridz01/TGraph/TGraph_ScifiPoint_irregularbin_121022.txt");
    ...
    TFile* fout2 = new TFile("/eos/user/r/ridz01/TGraph/TGraph_Scifi_NC_energy_ScifiPoint_irregular_0_121022.root","RECREATE");    
    ...
    TFile* fout2_err = new TFile("/eos/user/r/ridz01/TGraph/TGraph_Scifi_NC_energy_errors_ScifiPoint_irregular_121022.root","RECREATE");
    ...
    c0->SaveAs("TGraph_00_(final).png");

    auto c1 = new TCanvas();
    Sci_NC_gr_hist_01_err->Draw("AP");
    c1->SaveAs("TGraph_01_(final).png");

    auto c2 = new TCanvas();
    Sci_NC_gr_hist_02_err->Draw("AP");
    c2->SaveAs("TGraph_02_(final)n.png");

    auto c3 = new TCanvas();
    Sci_NC_gr_hist_03_err->Draw("AP");
    c3->SaveAs("TGraph_03_(final).png");

    auto c4 = new TCanvas();
    Sci_NC_gr_hist_04_err->Draw("AP");
    c4->SaveAs("TGraph_04_(final).png");
