...
(Scifi hits digitised)*/

// Event Station method
...
void scifi_hist_energy_DigiScifi(){
    ...
    TFile* fout3 = new TFile("/eos/user/r/ridz01/Hist_SciFi_NC_energy_DigiScifi_irregular_231122_200files.root","RECREATE");
