/* Script to determine the binning edges to perform adaptive binning for true Scifihits */
#include <algorithm>
...
void scifi_hist_energy_ScifiPoint_binning(){
    ...
    ofstream file0;
    file0.open ("/eos/user/r/ridz01/EnergyBins_0_200.txt");
    ...
    ofstream file1;
    file1.open ("/eos/user/r/ridz01/EnergyBins_1_200.txt");
    ...
    ofstream file2;
    file2.open ("/eos/user/r/ridz01/EnergyBins_2_200.txt");
    ...
    ofstream file3;
    file3.open ("/eos/user/r/ridz01/EnergyBins_3_200.txt");
    ...
    ofstream file4;
    file4.open ("/eos/user/r/ridz01/EnergyBins_4_200.txt");
